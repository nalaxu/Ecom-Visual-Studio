...
// 暂时用简单的 SVG 替代 Lucide 图标，后续安装了 lucide-react 我们可以替换掉
...
const ImagePickerIcon = () => <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><rect width="18" height="18" x="3" y="3" rx="2" ry="2"/><circle cx="9" cy="9" r="2"/><path d="m21 15-3.086-3.086a2 2 0 0 0-2.828 0L6 21"/></svg>;
...
const navItems = [
  ...
  { name: 'Tasks', href: '/tasks', icon: ImagePickerIcon },
